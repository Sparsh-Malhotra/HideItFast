// console.log('from foreground');
{
  ...
  let blackbg = document.querySelector(
    '#movie_player > div.html5-video-container > video'
  );
  let heading = document.querySelector('#container > h1');
  let orignalText = document.querySelector('#container > h1').innerText;
  let sideBar = document.querySelector('#secondary.ytd-watch-flexy');
  const img = document.createElement('img');
  var randomNames = [
    'Chill Music video :)',
    'Why is Javascript and Python Important!',
  ...
  var randomLink =
    'https://i.ibb.co/qWMmKHc/126679-28719-BC1-B2-A4-4632-AF68-F9-BC99667259-0-1.gif';
  img.src = randomLink;
  ...
  function videoBlack() {
    ...
    function toggle() {
      ...
      tgl
        ? (heading.innerText = randomNames[random])
        : (heading.innerText = orignalText);
      tgl
